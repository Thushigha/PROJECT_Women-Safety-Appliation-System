...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($username_err) && empty($mobile_err) && empty($police_station_err) && empty($password_err) && empty($role_err) && empty($email_err)) {
    // Prepare an insert statement
    $sql = "INSERT INTO police_users (username, mobile, email, police_station) VALUES (:username, :mobile, :email, :police_station)";
