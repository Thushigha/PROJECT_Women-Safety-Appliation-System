        ...
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
              <h6 class="text-white text-capitalize ps-3">Police Users </h6>
              <div class="col-6 text-end">
                <a class="btn bg-gradient-dark mb-0" href="add_police_user.php"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add Police Users</a>
              ...
              if ($result = $pdo->query($sql)) {
                if ($result->rowCount() > 0) {
                  ...
                  while ($row = $result->fetch()) {
                    ...
                    echo "<td>";
                    echo '<a href="police_user_update.php?id=' . $row['id'] . '" class="px-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                    echo '<a href="police_user_delete.php?id=' . $row['id'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                    echo "</td>";
        ...
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
              ...
              <div class="col-6 text-end">
                <a class="btn bg-gradient-dark mb-0" href="add_police_station.php"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add Police Station</a>
              </div>
            </div>
          </div>
          <div class="card-body pb-2">
              ...
              if ($result_station = $pdo->query($sql_station)) {
                if ($result_station->rowCount() > 0) {
                  ...
                  while ($row = $result_station->fetch()) {
                    ...
                    echo "<td>";
                    echo '<a href="police_station_update.php?id=' . $row['id'] . '" class="px-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                    echo '<a href="police_station_delete.php?id=' . $row['id'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                    echo "</td>";
