...
if (isset($_POST["id"]) && !empty($_POST["id"])) {
    ...
    if (empty($username_err) && empty($mobile_err) && empty($police_station_err) && empty($role_err) && empty($email_err)) {
        // Prepare an update statement
        $sql = "UPDATE police_users SET username=:username, email=:email, mobile=:mobile, police_station=:police_station WHERE id=:id";

        // update into users table
        $sql2 = "UPDATE users SET username=:username, mobile=:mobile, email=:email, role=:role WHERE id=:id";
...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">UPDATE POLICE USER</h4>
