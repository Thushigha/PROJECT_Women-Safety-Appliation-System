        ...
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
              <h6 class="text-white text-capitalize ps-3">Complaints </h6>
              <div class="col-6 text-end">
                <a class="btn bg-gradient-dark mb-0" href="add_complaints.php"><i class="material-icons text-sm">add</i>&nbsp;&nbsp;Add New Complaint</a>
              </div>
            </div>
          </div>
            ...
            <?php
              ...
              if ($result = $pdo->query($sql)) {
                if ($result->rowCount() > 0) {
                  ...
                  echo '<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Harresment</th>';
                  ...
                  while ($row = $result->fetch()) {
                    ...
                    echo "<td>" . $row['harresment'] . "</td>";
                    echo "<td>" . $row['date'] . "</td>";
                    echo "<td>" . $row['status'] . "</td>";
                    echo "<td>";
                    echo '<a href="complaint_update.php?id=' . $row['id'] . '" class="px-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                    echo '<a href="complaint_delete.php?id=' . $row['id'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                    echo "</td>";
